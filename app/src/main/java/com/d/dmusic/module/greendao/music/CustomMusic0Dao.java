...
/** 
 * DAO for table "CUSTOM_MUSIC0".
*/
public class CustomMusic0Dao extends AbstractDao<CustomMusic0, String> {

    public static final String TABLENAME = "CUSTOM_MUSIC0";

    /**
     * Properties of entity CustomMusic0.<br/>
    ...
    */
    ...
    public CustomMusic0Dao(DaoConfig config) {
        super(config);
    }
    
    public CustomMusic0Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CUSTOM_MUSIC0\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CUSTOM_MUSIC0\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, CustomMusic0 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public CustomMusic0 readEntity(Cursor cursor, int offset) {
        CustomMusic0 entity = new CustomMusic0( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, CustomMusic0 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(CustomMusic0 entity, long rowId) {
        return entity.getUrl();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(CustomMusic0 entity) {
        if(entity != null) {
            return entity.getUrl();
        } else {
            return null;
