...
/** 
 * DAO for table "CUSTOM_MUSIC10".
*/
public class CustomMusic10Dao extends AbstractDao<CustomMusic10, String> {

    public static final String TABLENAME = "CUSTOM_MUSIC10";

    /**
     * Properties of entity CustomMusic10.<br/>
    ...
    */
    ...
    public CustomMusic10Dao(DaoConfig config) {
        super(config);
    }
    
    public CustomMusic10Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CUSTOM_MUSIC10\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CUSTOM_MUSIC10\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, CustomMusic10 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public CustomMusic10 readEntity(Cursor cursor, int offset) {
        CustomMusic10 entity = new CustomMusic10( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, CustomMusic10 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(CustomMusic10 entity, long rowId) {
        return entity.getUrl();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(CustomMusic10 entity) {
        if(entity != null) {
            return entity.getUrl();
        } else {
            return null;
