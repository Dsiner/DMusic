...
/** 
 * DAO for table "CUSTOM_MUSIC11".
*/
public class CustomMusic11Dao extends AbstractDao<CustomMusic11, String> {

    public static final String TABLENAME = "CUSTOM_MUSIC11";

    /**
     * Properties of entity CustomMusic11.<br/>
    ...
    */
    ...
    public CustomMusic11Dao(DaoConfig config) {
        super(config);
    }
    
    public CustomMusic11Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CUSTOM_MUSIC11\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CUSTOM_MUSIC11\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, CustomMusic11 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public CustomMusic11 readEntity(Cursor cursor, int offset) {
        CustomMusic11 entity = new CustomMusic11( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, CustomMusic11 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(CustomMusic11 entity, long rowId) {
        return entity.getUrl();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(CustomMusic11 entity) {
        if(entity != null) {
            return entity.getUrl();
        } else {
            return null;
