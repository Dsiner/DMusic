...
/** 
 * DAO for table "CUSTOM_MUSIC13".
*/
public class CustomMusic13Dao extends AbstractDao<CustomMusic13, String> {

    public static final String TABLENAME = "CUSTOM_MUSIC13";

    /**
     * Properties of entity CustomMusic13.<br/>
    ...
    */
    ...
    public CustomMusic13Dao(DaoConfig config) {
        super(config);
    }
    
    public CustomMusic13Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CUSTOM_MUSIC13\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CUSTOM_MUSIC13\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, CustomMusic13 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public CustomMusic13 readEntity(Cursor cursor, int offset) {
        CustomMusic13 entity = new CustomMusic13( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, CustomMusic13 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(CustomMusic13 entity, long rowId) {
        return entity.getUrl();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(CustomMusic13 entity) {
        if(entity != null) {
            return entity.getUrl();
        } else {
            return null;
