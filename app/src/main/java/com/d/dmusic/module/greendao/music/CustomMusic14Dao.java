...
/** 
 * DAO for table "CUSTOM_MUSIC14".
*/
public class CustomMusic14Dao extends AbstractDao<CustomMusic14, String> {

    public static final String TABLENAME = "CUSTOM_MUSIC14";

    /**
     * Properties of entity CustomMusic14.<br/>
    ...
    */
    ...
    public CustomMusic14Dao(DaoConfig config) {
        super(config);
    }
    
    public CustomMusic14Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CUSTOM_MUSIC14\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CUSTOM_MUSIC14\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, CustomMusic14 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public CustomMusic14 readEntity(Cursor cursor, int offset) {
        CustomMusic14 entity = new CustomMusic14( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, CustomMusic14 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(CustomMusic14 entity, long rowId) {
        return entity.getUrl();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(CustomMusic14 entity) {
        if(entity != null) {
            return entity.getUrl();
        } else {
            return null;
