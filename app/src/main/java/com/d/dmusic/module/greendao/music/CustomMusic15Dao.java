...
/** 
 * DAO for table "CUSTOM_MUSIC15".
*/
public class CustomMusic15Dao extends AbstractDao<CustomMusic15, String> {

    public static final String TABLENAME = "CUSTOM_MUSIC15";

    /**
     * Properties of entity CustomMusic15.<br/>
    ...
    */
    ...
    public CustomMusic15Dao(DaoConfig config) {
        super(config);
    }
    
    public CustomMusic15Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CUSTOM_MUSIC15\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CUSTOM_MUSIC15\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, CustomMusic15 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public CustomMusic15 readEntity(Cursor cursor, int offset) {
        CustomMusic15 entity = new CustomMusic15( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, CustomMusic15 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(CustomMusic15 entity, long rowId) {
        return entity.getUrl();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(CustomMusic15 entity) {
        if(entity != null) {
            return entity.getUrl();
        } else {
            return null;
