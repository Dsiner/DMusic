...
*/
public class CustomMusic16Dao extends AbstractDao<CustomMusic16, String> {

    public static final String TABLENAME = "CUSTOM_MUSIC16";

    /**
     * Properties of entity CustomMusic16.<br/>
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, CustomMusic16 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public CustomMusic16 readEntity(Cursor cursor, int offset) {
        CustomMusic16 entity = new CustomMusic16( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, CustomMusic16 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(CustomMusic16 entity, long rowId) {
        return entity.getUrl();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(CustomMusic16 entity) {
        if(entity != null) {
            return entity.getUrl();
        } else {
            return null;
