...
/** 
 * DAO for table "CUSTOM_MUSIC17".
*/
public class CustomMusic17Dao extends AbstractDao<CustomMusic17, String> {

    public static final String TABLENAME = "CUSTOM_MUSIC17";

    /**
     * Properties of entity CustomMusic17.<br/>
    ...
    */
    ...
    public CustomMusic17Dao(DaoConfig config) {
        super(config);
    }
    
    public CustomMusic17Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CUSTOM_MUSIC17\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CUSTOM_MUSIC17\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, CustomMusic17 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public CustomMusic17 readEntity(Cursor cursor, int offset) {
        CustomMusic17 entity = new CustomMusic17( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, CustomMusic17 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(CustomMusic17 entity, long rowId) {
        return entity.getUrl();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(CustomMusic17 entity) {
        if(entity != null) {
            return entity.getUrl();
        } else {
            return null;
