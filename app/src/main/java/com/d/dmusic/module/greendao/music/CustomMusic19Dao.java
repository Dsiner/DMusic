...
/** 
 * DAO for table "CUSTOM_MUSIC19".
*/
public class CustomMusic19Dao extends AbstractDao<CustomMusic19, String> {

    public static final String TABLENAME = "CUSTOM_MUSIC19";

    /**
     * Properties of entity CustomMusic19.<br/>
    ...
    */
    ...
    public CustomMusic19Dao(DaoConfig config) {
        super(config);
    }
    
    public CustomMusic19Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CUSTOM_MUSIC19\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CUSTOM_MUSIC19\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, CustomMusic19 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public CustomMusic19 readEntity(Cursor cursor, int offset) {
        CustomMusic19 entity = new CustomMusic19( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, CustomMusic19 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(CustomMusic19 entity, long rowId) {
        return entity.getUrl();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(CustomMusic19 entity) {
        if(entity != null) {
            return entity.getUrl();
        } else {
            return null;
