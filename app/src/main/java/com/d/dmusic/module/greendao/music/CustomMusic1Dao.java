...
/** 
 * DAO for table "CUSTOM_MUSIC1".
*/
public class CustomMusic1Dao extends AbstractDao<CustomMusic1, String> {

    public static final String TABLENAME = "CUSTOM_MUSIC1";

    /**
     * Properties of entity CustomMusic1.<br/>
    ...
    */
    ...
    public CustomMusic1Dao(DaoConfig config) {
        super(config);
    }
    
    public CustomMusic1Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CUSTOM_MUSIC1\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CUSTOM_MUSIC1\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, CustomMusic1 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public CustomMusic1 readEntity(Cursor cursor, int offset) {
        CustomMusic1 entity = new CustomMusic1( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, CustomMusic1 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(CustomMusic1 entity, long rowId) {
        return entity.getUrl();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(CustomMusic1 entity) {
        if(entity != null) {
            return entity.getUrl();
        } else {
            return null;
