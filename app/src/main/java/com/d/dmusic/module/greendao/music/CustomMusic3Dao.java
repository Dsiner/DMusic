...
*/
public class CustomMusic3Dao extends AbstractDao<CustomMusic3, String> {

    public static final String TABLENAME = "CUSTOM_MUSIC3";

    /**
     * Properties of entity CustomMusic3.<br/>
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, CustomMusic3 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public CustomMusic3 readEntity(Cursor cursor, int offset) {
        CustomMusic3 entity = new CustomMusic3( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, CustomMusic3 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(CustomMusic3 entity, long rowId) {
        return entity.getUrl();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(CustomMusic3 entity) {
        if(entity != null) {
            return entity.getUrl();
        } else {
            return null;
