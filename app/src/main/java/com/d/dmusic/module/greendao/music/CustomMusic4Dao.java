...
/** 
 * DAO for table "CUSTOM_MUSIC4".
*/
public class CustomMusic4Dao extends AbstractDao<CustomMusic4, String> {

    public static final String TABLENAME = "CUSTOM_MUSIC4";

    /**
     * Properties of entity CustomMusic4.<br/>
    ...
    */
    ...
    public CustomMusic4Dao(DaoConfig config) {
        super(config);
    }
    
    public CustomMusic4Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CUSTOM_MUSIC4\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CUSTOM_MUSIC4\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, CustomMusic4 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public CustomMusic4 readEntity(Cursor cursor, int offset) {
        CustomMusic4 entity = new CustomMusic4( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, CustomMusic4 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(CustomMusic4 entity, long rowId) {
        return entity.getUrl();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(CustomMusic4 entity) {
        if(entity != null) {
            return entity.getUrl();
        } else {
            return null;
