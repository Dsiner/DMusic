...
/** 
 * DAO for table "CUSTOM_MUSIC5".
*/
public class CustomMusic5Dao extends AbstractDao<CustomMusic5, String> {

    public static final String TABLENAME = "CUSTOM_MUSIC5";

    /**
     * Properties of entity CustomMusic5.<br/>
    ...
    */
    ...
    public CustomMusic5Dao(DaoConfig config) {
        super(config);
    }
    
    public CustomMusic5Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CUSTOM_MUSIC5\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CUSTOM_MUSIC5\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, CustomMusic5 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public CustomMusic5 readEntity(Cursor cursor, int offset) {
        CustomMusic5 entity = new CustomMusic5( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, CustomMusic5 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(CustomMusic5 entity, long rowId) {
        return entity.getUrl();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(CustomMusic5 entity) {
        if(entity != null) {
            return entity.getUrl();
        } else {
            return null;
