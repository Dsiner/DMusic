...
/** 
 * DAO for table "CUSTOM_MUSIC6".
*/
public class CustomMusic6Dao extends AbstractDao<CustomMusic6, String> {

    public static final String TABLENAME = "CUSTOM_MUSIC6";

    /**
     * Properties of entity CustomMusic6.<br/>
    ...
    */
    ...
    public CustomMusic6Dao(DaoConfig config) {
        super(config);
    }
    
    public CustomMusic6Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CUSTOM_MUSIC6\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CUSTOM_MUSIC6\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, CustomMusic6 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public CustomMusic6 readEntity(Cursor cursor, int offset) {
        CustomMusic6 entity = new CustomMusic6( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, CustomMusic6 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(CustomMusic6 entity, long rowId) {
        return entity.getUrl();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(CustomMusic6 entity) {
        if(entity != null) {
            return entity.getUrl();
        } else {
            return null;
