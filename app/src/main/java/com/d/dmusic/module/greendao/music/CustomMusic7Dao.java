...
/** 
 * DAO for table "CUSTOM_MUSIC7".
*/
public class CustomMusic7Dao extends AbstractDao<CustomMusic7, String> {

    public static final String TABLENAME = "CUSTOM_MUSIC7";

    /**
     * Properties of entity CustomMusic7.<br/>
    ...
    */
    ...
    public CustomMusic7Dao(DaoConfig config) {
        super(config);
    }
    
    public CustomMusic7Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CUSTOM_MUSIC7\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CUSTOM_MUSIC7\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, CustomMusic7 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public CustomMusic7 readEntity(Cursor cursor, int offset) {
        CustomMusic7 entity = new CustomMusic7( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, CustomMusic7 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(CustomMusic7 entity, long rowId) {
        return entity.getUrl();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(CustomMusic7 entity) {
        if(entity != null) {
            return entity.getUrl();
        } else {
            return null;
