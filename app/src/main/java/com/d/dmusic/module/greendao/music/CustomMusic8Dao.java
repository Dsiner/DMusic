...
/** 
 * DAO for table "CUSTOM_MUSIC8".
*/
public class CustomMusic8Dao extends AbstractDao<CustomMusic8, String> {

    public static final String TABLENAME = "CUSTOM_MUSIC8";

    /**
     * Properties of entity CustomMusic8.<br/>
    ...
    */
    ...
    public CustomMusic8Dao(DaoConfig config) {
        super(config);
    }
    
    public CustomMusic8Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CUSTOM_MUSIC8\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CUSTOM_MUSIC8\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, CustomMusic8 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public CustomMusic8 readEntity(Cursor cursor, int offset) {
        CustomMusic8 entity = new CustomMusic8( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, CustomMusic8 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(CustomMusic8 entity, long rowId) {
        return entity.getUrl();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(CustomMusic8 entity) {
        if(entity != null) {
            return entity.getUrl();
        } else {
            return null;
