...
*/
public class CustomMusic9Dao extends AbstractDao<CustomMusic9, String> {

    public static final String TABLENAME = "CUSTOM_MUSIC9";

    /**
     * Properties of entity CustomMusic9.<br/>
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, CustomMusic9 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public CustomMusic9 readEntity(Cursor cursor, int offset) {
        CustomMusic9 entity = new CustomMusic9( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, CustomMusic9 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(CustomMusic9 entity, long rowId) {
        return entity.getUrl();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(CustomMusic9 entity) {
        if(entity != null) {
            return entity.getUrl();
        } else {
            return null;
