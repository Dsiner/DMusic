...
/** 
 * DAO for table "LOCAL_ALL_MUSIC".
*/
public class LocalAllMusicDao extends AbstractDao<LocalAllMusic, String> {

    public static final String TABLENAME = "LOCAL_ALL_MUSIC";

    /**
     * Properties of entity LocalAllMusic.<br/>
    ...
    */
    ...
    public LocalAllMusicDao(DaoConfig config) {
        super(config);
    }
    
    public LocalAllMusicDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"LOCAL_ALL_MUSIC\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"LOCAL_ALL_MUSIC\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, LocalAllMusic entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public LocalAllMusic readEntity(Cursor cursor, int offset) {
        LocalAllMusic entity = new LocalAllMusic( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, LocalAllMusic entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(LocalAllMusic entity, long rowId) {
        return entity.getUrl();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(LocalAllMusic entity) {
        if(entity != null) {
            return entity.getUrl();
        } else {
            return null;
