...
import com.d.music.module.greendao.music.DaoMaster;
import com.d.music.module.greendao.music.DaoSession;
...
public abstract class MusicDB extends AbstractDB<DaoMaster, DaoSession, MusicModel> {
    ...
    protected MusicDB(Context context) {
        super(context);
        DaoMaster.DevOpenHelper helper = new DaoMaster.DevOpenHelper(context.getApplicationContext(), "music.db", null);
