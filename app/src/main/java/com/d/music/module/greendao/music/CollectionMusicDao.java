...
/** 
 * DAO for table "COLLECTION_MUSIC".
*/
public class CollectionMusicDao extends AbstractDao<CollectionMusic, String> {

    public static final String TABLENAME = "COLLECTION_MUSIC";

    /**
     * Properties of entity CollectionMusic.<br/>
    ...
    */
    ...
    public CollectionMusicDao(DaoConfig config) {
        super(config);
    }
    
    public CollectionMusicDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COLLECTION_MUSIC\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"COLLECTION_MUSIC\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, CollectionMusic entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public CollectionMusic readEntity(Cursor cursor, int offset) {
        CollectionMusic entity = new CollectionMusic( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, CollectionMusic entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(CollectionMusic entity, long rowId) {
        return entity.getUrl();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(CollectionMusic entity) {
        if(entity != null) {
            return entity.getUrl();
        } else {
            return null;
