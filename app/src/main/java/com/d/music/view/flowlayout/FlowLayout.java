package com.d.music.view.flowlayout;
...
public class FlowLayout extends ViewGroup {
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        float padding = typedArray.getDimension(R.styleable.FlowLayout_flow_padding, 0);
        mPaddingLeft = typedArray.getDimension(R.styleable.FlowLayout_flow_paddingLeft, padding);
        mPaddingTop = typedArray.getDimension(R.styleable.FlowLayout_flow_paddingTop, padding);
        mPaddingRight = typedArray.getDimension(R.styleable.FlowLayout_flow_paddingRight, padding);
        mPaddingBottom = typedArray.getDimension(R.styleable.FlowLayout_flow_paddingBottom, padding);
        mDividerWidth = typedArray.getDimension(R.styleable.FlowLayout_flow_dividerWidth, 0);
        mDividerHeight = typedArray.getDimension(R.styleable.FlowLayout_flow_dividerHeight, 0);
        typedArray.recycle();
    }
