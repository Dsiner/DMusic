...
public class ScrollTab extends HorizontalScrollView implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        ...
        padding = typedArray.getDimension(R.styleable.ScrollTab_stab_padding, Util.dip2px(context, 12));
        ...
        indicatorWidth = typedArray.getDimension(R.styleable.ScrollTab_stab_indicator_width, 0);
        indicatorWeight = typedArray.getDimension(R.styleable.ScrollTab_stab_indicator_weight, Util.dip2px(context, 1));
        indicatorRadius = typedArray.getDimension(R.styleable.ScrollTab_stab_indicator_radius, Util.dip2px(context, 0.5f));
        indicatorPadding = typedArray.getDimension(R.styleable.ScrollTab_stab_indicator_padding, Util.dip2px(context, 5));
        typedArray.recycle();
    }
    ...
    private void init(Context context) {
        ...
        indicatorColor = SkinManager.getInstance().getColor(R.color.color_main);
        rectF = new RectF();
