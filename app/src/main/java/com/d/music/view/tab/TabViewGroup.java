...
public class TabViewGroup extends RelativeLayout implements TabView {
    ...
    private void init(Context context) {
        ...
        this.color = ContextCompat.getColor(context, R.color.color_gray);
        this.colorCur = SkinManager.getInstance().getColor(R.color.color_main);
    ...
    public void onWindowFocusChanged(boolean hasWindowFocus) {
        if (hasWindowFocus) {
            colorCur = SkinManager.getInstance().getColor(R.color.color_main);
        }
